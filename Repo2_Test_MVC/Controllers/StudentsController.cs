...
using Repo2_Test_MVC.Models;

namespace Repo2_Test_MVC.Controllers
{
    public class StudentsController : Controller
    {
        private ThisDBContainer db = new ThisDBContainer();
        ...
        public async Task<ActionResult> Create([Bind(Include = "StudentId,Name,Phone,Address,IsDelete,SectionId")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "StudentId,Name,Phone,Address,IsDelete,SectionId")] Student student)
        {
            if (ModelState.IsValid)
            {
