...
namespace Repo2_Test_MVC.Controllers
{
    public class SectionsController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "SectionId,Name,IsDelete")] Section section)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "SectionId,Name,IsDelete")] Section section)
        {
            if (ModelState.IsValid)
            {
